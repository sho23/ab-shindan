...
<head>
    ...
    <meta property="og:image"       content="<?php echo $__env->yieldContent('ogimg') !== '' ? $__env->yieldContent('ogimg') : asset('image/bg-yellow.png'); ?>">

    <meta name="twitter:image"      content="<?php echo $__env->yieldContent('ogimg') !== '' ? $__env->yieldContent('ogimg') : asset('image/bg-yellow.png'); ?>">
